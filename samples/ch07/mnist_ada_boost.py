...
classifiers = [
    ("ada_boost_10", AdaBoostClassifier(DecisionTreeClassifier(criterion='entropy', splitter='best'), n_estimators=10)),
    ("ada_boost_50", AdaBoostClassifier(DecisionTreeClassifier(criterion='entropy', splitter='best'), n_estimators=50)),
    ("ada_boost_100", AdaBoostClassifier(DecisionTreeClassifier(criterion='entropy', splitter='best'), n_estimators=100))
]
