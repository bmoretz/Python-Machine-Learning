...
def check_mnist_multiclass_data (data, y, m_row, n_column, filename):
    N_max = data.shape[0]
    N = m_row * n_column
...
y_pred_rfc = rfc_clf.predict_proba (X_test[0:n_samples])
print(y_pred_rfc)

check_mnist_multiclass_data (X_test[0:n_samples], y_test[0:n_samples], 1, 20, "./multiclass/" + "multiclass2.jpg")
